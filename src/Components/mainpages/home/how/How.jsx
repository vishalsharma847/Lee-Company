    ...
    <div className="flex flex-col items-center m-8 text-center">
      ...
      <div className="flex flex-col w-full justify-evenly lg:flex-row lg:justify-around">
        <div className=" flex flex-col items-center">
          {call?<img src="/src/assets/call-us.png" onClick={()=>setCall(false)} alt="call-now" className="size-60 md:size-48 " />:<img src="./src/assets/call-us.gif" onClick={()=>setCall(true)} alt="call-now" className="size-60 md:size-48" />}
        ...
        <div className=" flex flex-col items-center">
          {visit?<img src="/src/assets/visit-boy.png" onClick={()=>setVisit(false)} alt="visit" className="size-60 md:size-48"/>:<img src="./src/assets/visits.gif" onClick={()=>setVisit(true)} alt="visit" className="size-60 md:size-48"/>}
        ...
        <div className=" flex flex-col items-center">
        {book?<img src="/src/assets/Booking.png" onClick={()=>setBook(false)} alt="book" className="size-60 md:size-48"/>:<img src="./src/assets/book.gif" onClick={()=>setBook(true)} alt="book" className="size-60 md:size-48"/>}
        ...
        <div className=" flex flex-col items-center">
        {done?<img src="/src/assets/done.png" onClick={()=>setDone(false)} alt="visit" className="size-60 md:size-48"/>:<img src="./src/assets/done.gif" onClick={()=>setDone(true)} alt="Affordable" className="size-60 md:size-48"/>}
