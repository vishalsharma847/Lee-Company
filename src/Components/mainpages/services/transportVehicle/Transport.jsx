  ...
  return (
    <div className="flex  flex-col items-center">
      <div className="flex flex-col justify-center items-center text-center mt-16 mb-4">
        <h1 className="mt-8 text-2xl font-bold w-4/5">Transport Vehicle</h1>
      ...
      <div className="flex items-center flex-col text-center w-3/4">
        ...
        <p className="w-full mb-3">
          Relocating can be a significant undertaking, and the transportation of
          your belongings plays a pivotal role in ensuring a successful and
          stress-free move. At Lee Home Packers and Movers, we take pride in
          offering top-notch transportation services that prioritize the safety
          and timely delivery of your cherished possessions. With a wealth of
          experience in the industry, our reliable transportation solutions
          guarantee a smooth ride for your belongings, providing you with peace
          of mind throughout the entire relocation process.
        </p>
          ...
          <div className="flex flex-col w-full items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center w-4/5 ">
              ...
              <p className="text-left mb-4">
                ...
                relocation journey. With our dedication to reliability, safety,
                and customer satisfaction, you can trust us to transport your
                items with utmost care and professionalism. Contact us today to
                experience the difference of our top-notch transport vehicle
                services and make your move a stress-free and memorable one. Let
                us handle the transportation of your valued possessions, while
                you focus on embracing the new chapter of your life with
