  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col justify-center items-center text-center mt-16 mb-4">
        <h1 className="mt-8 text-2xl font-bold w-4/5 lg:w-fit">Warehousing Services</h1>
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-evenly lg:mt-10 lg:mb-20">
        ...
        <div className="flex items-center flex-col text-center w-3/4 lg:w-1/2">
          ...
          <p className="italic text-sm w-4/5">
            "Our spacious and well-maintained warehousing facilities are
            equipped with cutting-edge security systems, including 24/7
            surveillance and access control, to safeguard your valuables at all
            times. Our safe and secure warehousing services are ideal for
            preserving the integrity of sensitive items, such as electronics,
            documents, and valuable possessions."
          </p>
        </div>
      </div>
      <div className="flex flex-col text-center justify-center items-center">
        <div className="flex flex-col items-center w-full lg:justify-evenly lg:flex-row">
          <div className="flex flex-col w-full lg:w-1/2  items-center justify-center">
            <h3 className="p-2 border-black border-2 m-4 w-fit">
            ...
            <div className="flex flex-col items-center justify-center w-4/5 ">
              ...
              <div className="flex flex-col justify-center items-center lg:hidden">
                <p className="text-left mb-4">
                  When it comes to secure and efficient warehousing solutions,
                  Lee Home Packers and Movers is your go-to partner. With our
                  advanced facilities, flexible storage options, and
                  customer-centric approach, we ensure the safety and
                  preservation of your belongings. Whether you need short-term
                  or long-term storage, trust us to provide a seamless
                  experience. Contact us today to discuss your warehousing needs
                  and discover how our top-notch service can safeguard your
                  valuables with excellence.
                </p>
        ...
        <div className="hidden lg:flex lg:w-3/4 flex-col justify-center items-center">
          <p className="text-left mb-4">
            ...
            facilities, flexible storage options, and customer-centric approach,
            we ensure the safety and preservation of your belongings. Whether
            you need short-term or long-term storage, trust us to provide a
            seamless experience. Contact us today to discuss your warehousing
            needs and discover how our top-notch service can safeguard your
            valuables with excellence.
          </p>
          <p className="mb-12 text-left">
            Contact us today for a free quote and take the first step towards a
            stress-free warehousing service!
          </p>
        </div>
      </div>
    </div>
