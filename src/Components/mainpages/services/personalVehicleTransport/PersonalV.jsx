    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex items-center flex-col text-center w-3/4">
        ...
        <p className="w-full mb-3">
          ...
          comes with the challenge of transporting your cherished vehicles, such
          as cars and bikes, to your new destination. At Lee Home Packers and
          Movers, we understand the importance of your vehicles and the
          ...
          <div className="flex flex-col w-full items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center w-4/5 ">
              ...
              <p className="text-left mb-4">
                Lee Home Packers and Movers is your trusted companion for secure
                and reliable car and bike transportation. With our expertise,
                modern equipment, and customer-centric approach, we ensure the
                safe and timely delivery of your vehicles to your new
                destination. Let us handle the transportation of your cherished
                vehicles, while you focus on embracing the excitement of
                starting a new chapter in your life. With Lee Home Packers and
                Movers, your beloved cars and bikes are in safe hands, every
                step of the way.
              </p>
              <p className="mb-12 text-left">
                Contact us today to experience the difference of our top-notch
                car and bike transportation services and embark on a stress-free
                and memorable relocation journey!
              </p>
            </div>
          </div>
